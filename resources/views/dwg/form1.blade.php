...
@section('title')
Buat Data Drawing Baru
@endsection

@section('breadcrumb')
    @parent
    <li class="active">Buat Data Drawing Baru</li>
@endsection
...
<div class="row">
    <div class="col-lg-12">
        <div class="box">
            <form action="{{ route('dwg.store') }}" method="post" class="form-form1" data-toggle="validator" enctype="multipart/form-data">
                @csrf
                <div class="box-body">
