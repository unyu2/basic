            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="kode_emu" id="kode_emu" class="form-control" readonly> Cari token pada Form inspeksi | Di Isi Bila Ada
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="ncr" id="ncr" class="form-control" readonly> Cari No NCR Yang Mengandung Permasalahan
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group row">
                    <label for="id_proyek" class="col-lg-2 col-lg-offset-1 control-label">Proyek</label>
                        <div class="col-lg-6">
                        <select name="id_proyek" id="id_proyek" class="form-control" required autofocus readonly>
                    ...
                    <label for="id_car" class="col-lg-2 col-lg-offset-1 control-label">Trainset</label>
                        <div class="col-lg-6">
                        <select name="id_car" id="id_car" class="form-control" required autofocus readonly>
                    ...
                    <label for="car" class="col-lg-2 col-lg-offset-1 control-label">Car</label>
                        <div class="col-lg-6">
                        <select name="car" id="car" class="form-control" required autofocus readonly>
                                <option></option required autofocus>
                    ...
                    <label for="level" class="col-lg-2 col-lg-offset-1 control-label">Bobot</label>
                        <div class="col-lg-6">
                        <select name="level" id="level" class="form-control" required autofocus readonly>
                                <option></option required autofocus>
                                <option>Low</option>
                    ...
                    <label for="bagian" class="col-lg-2 col-lg-offset-1 control-label">Bagian</label>
                        <div class="col-lg-6">
                        <select name="bagian" id="bagian" class="form-control" required autofocus readonly>
                                <option></option>
                    ...
                    <label for="subsistem" class="col-lg-2 col-lg-offset-1 control-label">Sub System</label>
                        <div class="col-lg-6">
                        <select name="subsistem" id="subsistem" class="form-control" required autofocus readonly>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <textarea name="nama_temuan" id="nama_temuan" class="form-control" required autofocus readonly>    
                        </textarea>
                        <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    ...
                    <label for="id_produk" class="col-lg-2 col-lg-offset-1 control-label">Komponen Sesuai BOM/K</label>
                        <div class="col-lg-6">
                        <select name="id_produk" id="id_produk" class="form-control" required autofocus readonly>
                                <option value=""></option required autofocus>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input name="nama_produks" id="nama_produks" class="form-control" required autofocus readonly>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input name="jumlah" id="jumlah" class="form-control" required autofocus readonly>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <label for="jenis" class="col-lg-2 col-lg-offset-1 control-label">Jenis Permasalahan</label>
                        <div class="col-lg-6">
                        <select name="jenis" id="jenis" class="form-control" required autofocus readonly>
                                <option></option>
                    ...
                    <label for="dampak" class="col-lg-2 col-lg-offset-1 control-label">Dampak</label>
                        <div class="col-lg-6">
                        <select name="dampak" id="dampak" class="form-control" required autofocus readonly>
                                <option></option>
                    ...
                    <label for="frekuensi" class="col-lg-2 col-lg-offset-1 control-label">Frekuensi</label>
                        <div class="col-lg-6">
                        <select name="frekuensi" id="frekuensi" class="form-control" required autofocus readonly>
                                <option></option>
                    ...
                    <label for="pantau" class="col-lg-2 col-lg-offset-1 control-label">Keterpantauan</label>
                        <div class="col-lg-6">
                        <select name="pantau" id="pantau" class="form-control" required autofocus readonly>
                                <option></option>
                    ...
                    <label for="operasi" class="col-lg-2 col-lg-offset-1 control-label">Apakah Membuat Kereta Tidak Siap Operasi ??</label>
                        <div class="col-lg-6">
                        <select name="operasi" id="operasi" class="form-control" required autofocus readonly>
                                <option></option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input name="status" id="status" class="form-control" readonly readonly>
                        <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                        <select name="aksi" id="aksi" class="form-control" required autofocus readonly>
                        <option></option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <textarea name="penyelesaian" id="penyelesaian" class="form-control" required autofocus readonly>    
                        </textarea>
                        <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <textarea name="penyebab" id="penyebab" class="form-control" readonly>    
                        </textarea>
                        <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <textarea name="akibat1" id="akibat1" class="form-control" readonly>    
                        </textarea>
                        <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <textarea name="akibat2" id="akibat2" class="form-control" readonly >    
                        </textarea>
                        <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <textarea name="akibat3" id="akibat3" class="form-control" readonly>    
                        </textarea>
                        <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <textarea name="saran" id="saran" class="form-control" readonly>    
                        </textarea>
                        <span class="help-block with-errors"></span>
                        </div>
                    </div>
