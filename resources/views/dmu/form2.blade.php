    ...
    <div class="modal-dialog modal-lg" role="document">
        <form action="" method="post" class="form-horizontal" enctype="multipart/form-data" data-toggle="validator">
            ...
            <div class="modal-content">
                ...
                <div  class="control-label col-lg-9 col-lg-offset-0"><a> <b>## PERHATIAN !!! Form Ini Digunakan Untuk Merubah Dengan Revisi ! ##</b></a>
                </div> 
</div>
                <br>
                    <!-- 
                <div class="form-group row">
                       <label for="revisi" class="col-lg-2 col-lg-offset-1 control-label">Revisi Menjadi</label>
                    <div class="col-lg-6">
