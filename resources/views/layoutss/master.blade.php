...
<head>
  ...
  <!-- DataTables -->
   ...
   <link rel="stylesheet" href="https://cdn.datatables.net/1.13.4/css/dataTables.bootstrap.min.css" defer> 
...
<script src="https://cdn.datatables.net/1.13.4/js/dataTables.bootstrap.min.js" defer></script>

    <!-- Validator -->
   <!--  <script src="{{ asset('js/validator.min.js') }}"></script> -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/1000hz-bootstrap-validator/0.11.9/validator.min.js" defer></script> 
   <!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/1000hz-bootstrap-validator/0.11.9/validator.js" defer></script> -->
