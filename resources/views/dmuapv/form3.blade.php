    ...
    <form action="" method="post" class="form-horizontal" enctype="multipart/form-data" data-toggle="validator">
            ...
            <div class="modal-content">
                ...
                <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input placeholder="Approved" value="Approved" name="status" id="status" class="form-control" required autofocus readonly>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div> -->
                <div class="form-group row">
                       <label for="" class="col-lg-2 col-lg-offset-1 control-label">Revisi</label>
                    <div class="col-lg-6">
                       <input value="revisi" name="revisi" id="revisi" class="form-control" required autofocus readonly>
                       <span class="help-block with-errors"></span>
                   </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-2 col-lg-offset-1 control-label" for="foto1">Foto Sebelumnya</label>
                           <img id="foto1-preview" src="" alt="Foto 1" style="max-height: 200px;">
                   </div>
...
<div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label for="foto2" class="col-lg-2 col-lg-offset-1 control-label">Gambar Sub Sistem 1</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-2 col-lg-offset-1 control-label" for="foto2">Foto Sebelumnya</label>
                           <img id="foto2-preview" src="" alt="Foto 2" style="max-height: 200px;">
                   </div>
...
<div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label for="foto3" class="col-lg-2 col-lg-offset-1 control-label">Gambar Sub Sistem 1</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-2 col-lg-offset-1 control-label" for="foto3">Foto Sebelumnya</label>
                           <img id="foto3-preview" src="" alt="Foto 3" style="max-height: 200px;">
                   </div>
...
<div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label for="foto4" class="col-lg-2 col-lg-offset-1 control-label">Gambar Sub Sistem 1</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-2 col-lg-offset-1 control-label" for="foto4">Foto Sebelumnya</label>
                           <img id="foto4-preview" src="" alt="Foto 4" style="max-height: 200px;">
                   </div>
...
<div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-2 col-lg-offset-1 control-label" for="foto5">Foto Sebelumnya</label>
                           <img id="foto5-preview" src="" alt="Foto 5" style="max-height: 200px;">
                   </div>
...
<div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label for="foto6" class="col-lg-2 col-lg-offset-1 control-label">Gambar Sub Sistem 5</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-2 col-lg-offset-1 control-label" for="foto6">Foto Sebelumnya</label>
                           <img id="foto6-preview" src="" alt="Foto 6" style="max-height: 200px;">
                   </div>
...
<div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-2 col-lg-offset-1 control-label" for="foto6">Foto Sebelumnya</label>
                           <img id="foto7-preview" src="" alt="Foto 7" style="max-height: 200px;">
                   </div>
...
<div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-2 col-lg-offset-1 control-label" for="foto8">Foto Sebelumnya</label>
                           <img id="foto8-preview" src="" alt="Foto 8" style="max-height: 200px;">
                   </div>
...
<div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-2 col-lg-offset-1 control-label" for="foto9">Foto Sebelumnya</label>
                           <img id="foto9-preview" src="" alt="Foto 9" style="max-height: 200px;">
                   </div>
...
<div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-2 col-lg-offset-1 control-label" for="foto10">Foto Sebelumnya</label>
                           <img id="foto10-preview" src="" alt="Foto 10" style="max-height: 200px;">
                   </div>
...
<div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-2 col-lg-offset-1 control-label" for="foto10">Foto Sebelumnya</label>
                           <img id="foto11-preview" src="" alt="Foto 11" style="max-height: 200px;">
                   </div>
...
<div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-2 col-lg-offset-1 control-label" for="foto12">Foto Sebelumnya</label>
                           <img id="foto12-preview" src="" alt="Foto 12" style="max-height: 200px;">
                   </div>
...
<div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-2 col-lg-offset-1 control-label" for="foto13">Foto Sebelumnya</label>
                           <img id="foto13-preview" src="" alt="Foto 13" style="max-height: 200px;">
                   </div>
...
<div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-2 col-lg-offset-1 control-label" for="foto14">Foto Sebelumnya</label>
                           <img id="foto14-preview" src="" alt="Foto 14" style="max-height: 200px;">
                   </div>
...
<!---------------------------------------------------------------------------------------------------------------------------------------- -->
                ...
                <div class="modal-footer">
                    <button onclick="redirectTo" class="btn btn-sm btn-flat btn-primary"><i class="fa fa-save"></i> Approve</button>
