            ...
            <div class="modal-content">
                ...
                <div class="form-group row hidden-form">
                        <label for="duplicate_status_tekprod" class="col-lg-1 col-lg-offset-2 control-label">Duplicate Status</label>
                            <div class="col-lg-6">
                                <input type="text" value="Release" placeholder="Release" name="duplicate_status_tekprod" id="duplicate_status_tekprod" class="form-control" required autofocus>
                                <span class="help-block with-errors"></span>
                            </div>
                </div>
                <div class="form-group row hidden-form">
                        <label for="time_release_rev0_tekprod" class="col-lg-1 col-lg-offset-2 control-label">Time release Rev.0</label>
                            <div class="col-lg-6">
                                <input type="text" value="<?php echo date('Y-m-d'); ?>" placeholder="yyyy-mm-dd" name="time_release_rev0_tekprod" id="time_release_rev0_tekprod" class="form-control" required autofocus>
                                <span class="help-block with-errors"></span>
                            </div>
                </div>
                <div class="form-group row hidden-form">
                ...
                <div class="form-group row hidden-form">
                        <label for="tipe_tekprod" class="col-lg-1 col-lg-offset-2 control-label">Tipe</label>
                            <div class="col-lg-6">
                                <input name="tipe_tekprod" id="tipe_tekprod" class="form-control" required autofocus readonly>
                                <span class="help-block with-errors"></span>
                            </div>
                    </div>
