...
<script>
$(function() {
    var salesChartCanvas = $('#kurvas').get(0).getContext('2d');
    
    // Data kurva
    var salesChartKurvasData = {
        labels: {{ json_encode($data_tanggal) }},
        datasets: [
            {
                label: 'Closed',
                ...
                fill: false,
                data: {{ json_encode($data_closed_curva) }}
            },
            {
                label: 'Open',
                ...
                fill: false,
                data: {{ json_encode($data_open_curva) }}
            },
            {
                label: 'Target',
                ...
                fill: false,
                data: {{ json_encode($data_target_curva) }}
            }
        ]
    };

    // Opsi kurva
    var salesChartKurvasOptions = {
        responsive: true,
        maintainAspectRatio: false
    };

    console.log(salesChartKurvasData); // Tambahkan ini untuk debugging

    // Inisialisasi grafik kurva
    var salesChartKurvasInstance = new Chart(salesChartCanvas, {
        type: 'line',
        data: salesChartKurvasData,
        options: salesChartKurvasOptions
    });
});
