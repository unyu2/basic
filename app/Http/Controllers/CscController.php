...
class CscController extends Controller
{
  ...
  $r7= Dmu::where('id_subpengujian','10')->get();
    ...
    public function data()
    {
        ...
        $user = Auth::user();
            ...
            $dmu = Dmu::leftJoin('subpengujian', 'subpengujian.id_subpengujian', 'dmu.id_subpengujian')
                ->where('dmu.id_user', $user->id) // Filter data berdasarkan id_user yang sesuai dengan user yang sedang login
    ...
    public function create()
    {
        ...
        return view('dmu.form1', compact('dmu', 'subpengujian', 'proyek', 'sistem'));
    ...
    public function updatex(Request $request, $id)
{
    ...
    return redirect()->route('dmu.index')->with('success', 'Data berhasil disimpan');
    } 
}
